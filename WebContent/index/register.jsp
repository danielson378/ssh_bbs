			...
			<div class="mn">
				<div id="main_message" class="bm">
					...
					<div id="main_hnav" class="bm_h bbs">
						<h3 class="xs2" id="layer_reginfo_t">用户注册</h3>
					</div>
								...
								<div id="reginfo_a">
										...
										<table>
											<tbody>
												<tr>
													...
													<td><input type="password" class="px" size="25" name="user.passwordNew" id="password2" required="required"></td>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<div class="rfm">
										<table>
											<tbody>
												<tr>
													<th><span class="rq">*</span><label for="username">论坛昵称:</label></th>
													<td><input type="text" maxlength="15" size="25" class="px" name="user.nickname" id="nickname" required="required"></td>
												</tr>
											</tbody>
										</table>
									</div>
